//tealium universal tag - utag.2 ut4.0.201505221748, Copyright 2015 Tealium.com Inc. All Rights Reserved.
var s_account="rackdev";var s=s_gi(s_account);s.dynamicAccountSelection=true;s.dynamicAccountList="rsss50,rsglobal=support.rackspace.com,www.rackspace.com,docs.rackspace.com,community.rackspace.com;rsdocsinternal=docs-internal.rackspace.com,docs-staging.rackspace.com,docs-internal-staging.rackspace.com";s.trackDownloadLinks=true;s.trackExternalLinks=true;s.trackInlineStats=true;s.linkDownloadFileTypes="zip,exe,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx";s.linkInternalFilters="rackspace.com";s.linkLeaveQueryString=false;s.linkTrackVars="None";s.linkTrackEvents="None";s.usePlugins=false;s.currencyCode="USD";s.visitorNamespace="";s.trackingServer="rackspace.112.2o7.net";s.trackingServerSecure="";s.dc=122;var s_code='',s_objectID;function s_gi(un,pg,ss){var c="s.version='H.26';s.an=s_an;s.logDebug=function(m){var s=this,tcf=new Function('var e;try{console.log(\"'+s.rep(s.rep(s.rep(m,\"\\\\\",\"\\\\\\"
...
try{(function(id,loader,u){try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};u.ev={'view':1,'link':1,'video':1};u.o=s;u.varlist={pageName:'pageName',channel:'ch',campaign:'v0',hier1:'h1',hier2:'h2',hier3:'h3',hier4:'h4'};for(var i=1;i<76;i++){u.varlist['prop'+i]='c'+i;u.varlist['eVar'+i]='v'+i};u.pushlt=function(l,v){if(typeof l!="undefined")l.push(v)};u.map={"chat_page_name":"prop1,eVar1","chat_source":"prop2,eVar2","site_submission_type":"prop3,eVar3","signup_type":"prop4,eVar4","qp.icmp":"prop5,eVar5","login_account":"prop6,eVar6","cloud_calculator":"prop7,eVar7","solution_configurator":"prop8,eVar8","search_term":"prop9,eVar9","search_results":"prop10,eVar10","rack_id":"prop11,eVar11","site_language":"prop12,eVar12","dom.url":"prop13,eVar13","user_agent":"prop14,eVar14","customer_id":"prop15,eVar15","order_id":"prop16,eVar16,purchaseID","dom.domain":"prop17,eVar17","cloud_owner_role":"prop18,eVar18","cloud_status_30":"prop19,eVar19","cloud_status_60":"prop20,eVar20","cloud_status_90":"prop21,eVar21","owner_role":"prop22,eVar22","session_id":"prop23,eVar23","site_section":"prop24","page_type:confirmation":"event1","chat_action:offered":"event2","chat_action:declined":"event3","chat_action:accepted":"event4","chat_action:loaded":"event5","e_site_submission":"event6","e_account_login":"event8","e_solution_config":"event10","internal_search":"event11","ecom_event:cart":"scView","ecom_event:cart view":"scView","ecom_event:checkout":"scCheckout","ecom_event:add to cart":"scAdd","ecom_event:cart remove":"scRemove","ecom_event:product view":"prodView","page_name":"pageName","qp.q":"prop9,eVar9","channel":"channel","support_team":"prop61,eVar61"};u.extend=[function(a,b){s.getNewRepeat=new Function("d","cn",""
...
+"==0?0:a);}return v==k?'':v");s.getVisitNum=new Function("tp","c","c2",""
...
+"D,W];return a;}");},function(a,b){s._tpDST={2012:'3/11,11/4',2013:'3/10,11/3',2014:'3/9,11/2',2015:'3/8,11/1',2016:'3/13,11/6',2017:'3/12,11/5',2018:'3/11,11/4',2019:'3/10,11/3'}
s.usePlugins=true
function s_doPlugins(){s.events=s.events?s.events:'';if(b['qp.cid']){s.campaign=b['qp.cid']}
else if(b['qp.cm_mmc']){s.campaign=b['qp.cm_mmc']}
if(typeof b.page_name!='undefined'&&b.page_name.indexOf("404")!=-1)s.pageType="errorPage";s.prop25=s.getNewRepeat();s.prop26=s.getTimeParting('n','-10');}
s.doPlugins=s_doPlugins;},function(a,b){try{if(b['page_name'].toString().indexOf('404')>-1){b['error_page']='errorPage'}}catch(e){utag.DB(e)}}];u.send=function(a,b,c,d,e,f,g,h,ev){if(u.ev[a]||typeof u.ev.all!="undefined"){utag.DB("send:2");u.data={};u.a=a;b.sc_events=b.sc_events||{};u.addEvent=function(v,n){var t=[];if(v instanceof Array){t=v.slice(0);}else if(typeof n!="undefined"){t.push(v+"="+n);}else{t.push(v);}
...
try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('2','rackspace.support');}catch(e){};